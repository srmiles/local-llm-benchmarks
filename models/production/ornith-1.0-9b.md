...
- **b10068 ROLLED BACK to b9948 (2026-07-20 00:15 UTC)** — brain-eval caught an MTP acceptance regression: dropped 64% → 46% under real workload on b10068, decode dropped 50 → 41 tok/s. Bisect confirmed: rolling `docker tag llama.cpp:sycl-f16-b9948 llama.cpp:sycl-f16` + restart restored 68-74% acceptance / 49-51 tok/s. Trade-off: lose the b10068 XMX-FA cold prefill lift (22.8s → 12.1s) but recover the MTP throughput that matters more for our workload. Root-cause bisect of b9948..b10068 SYCL commits (XMX FA #25222, fattn_vec_nthreads #25205, Q4_K get_rows #25656) still owed. Version stamping in our build recipe is also broken — `build_info` reports `579 (074944998)` on b9948 and `699 (571d0d540)` on b10068; hashes are right, numbers are bogus. Need `-DLLAMA_BUILD_NUMBER=<tag>` at cmake time.
