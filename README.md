...
21. **B60 draws ~100W actual vs 220W TDP under sustained LLM load — compute engines pinned but half the die is idle.** Measured 2026-08-01 during brain-eval Track 2 arm 3 (Gemma 4 E4B + Google MTP, 2-5K token prompts, structured JSON output) via `xpu-smi stats`:
